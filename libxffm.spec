...
Summary(pl):	Biblioteka zarz±dzania plików dla aplikacji xffm
Name:		libxffm
Version:	4.5.0
Release:	1
License:	GPL
...
%description -l pl
libxffm jest podstawow± bibliotek± zarz±dzania plików u¿ywan± przez
aplikacje xffm.

%package devel
Summary:	Header files for libxffm library
Summary(pl):	Pliki nag³ówkowe dla biblioteki libxffm
...
Pliki nag³ówkowe dla biblioteki libxffm.
